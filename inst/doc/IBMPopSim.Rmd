...
If an **exit event** is defined, a characteristic `out` is automatically added to individuals in the population. When  an individual `I` exit the population, `I.out` is set `TRUE` and his exit time is recorded as a "death" date.
