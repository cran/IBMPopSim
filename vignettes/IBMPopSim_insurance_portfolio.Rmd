...
knitr::include_graphics("insur_forecast-1.pdf")
```
...
## [1] "exit event: add 'out' as individual attributes"
summary(model)
## Events:
## #1: individual event of type death
## #2: poisson event of type entry
## #3: individual event of type exit
## --------------------------------------- 
...
sim_out <- popsim(model = model,
    ...
    age_max = 110,
    multithreading = TRUE)
## Warning in popsim(model = model, population = pop_df, events_bounds = c(death =
## death_max, : Add 'entry' attributes to the population.
## Warning in popsim(model = model, population = pop_df, events_bounds = c(death =
## death_max, : Add 'out' attributes to the population.
## Simulation on  [0, 30]
```
...
## 'data.frame':	930799 obs. of  5 variables:
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("insur_pyramid-1.pdf")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("insur_pyr_group-1.pdf")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("insur_LeeCarter_risk1-1.pdf")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("insur_mortality_rates-1.pdf")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("insur_evol_mortality-1.pdf")
```
...
```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("insur_cohort-1.pdf")
```
